...
#[doc = r"Peripheral with a headerStructName"]
unsafe impl ::core::marker::Send for super::HeaderStruct {}
unsafe impl ::core::marker::Sync for super::HeaderStruct {}
impl super::HeaderStruct {
    #[allow(unused)]
    #[inline(always)]
