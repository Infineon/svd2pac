...
#[doc = r"Peripheral with a headerStructName and derived from another peripheral"]
unsafe impl ::core::marker::Send for super::HdrStructDerivedP33 {}
unsafe impl ::core::marker::Sync for super::HdrStructDerivedP33 {}
impl super::HdrStructDerivedP33 {
    #[allow(unused)]
    #[inline(always)]
