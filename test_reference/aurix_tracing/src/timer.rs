...
#[doc = "1 = Running: Timer is running"]
    #[inline(always)]
    pub fn run(self) -> 
    crate::common::RegisterFieldBool<0,1,0,Sr,common::R> {
...
#[doc = "1 = Match_Hit: The MATCH condition was hit"]
    #[inline(always)]
    pub fn r#match(self) -> 
    crate::common::RegisterFieldBool<8,1,0,Sr,common::RW> {
...
#[doc = "1 = Underflow: A minimum of one underflow occured since last clear"]
    #[inline(always)]
    pub fn un(self) -> 
    crate::common::RegisterFieldBool<9,1,0,Sr,common::RW> {
...
#[doc = "1 = Overflow_occured: A minimum of one overflow occured since last clear"]
    #[inline(always)]
    pub fn ov(self) -> 
    crate::common::RegisterFieldBool<10,1,0,Sr,common::RW> {
...
#[doc = "1 = In_Reset: Timer is in RESET state and can not operate"]
    #[inline(always)]
    pub fn rst(self) -> 
    crate::common::RegisterFieldBool<12,1,0,Sr,common::R> {
...
#[doc = "1 = Enable: Timer triggers the TIMERn Interrupt"]
    #[inline(always)]
    pub fn en(self) -> 
    crate::common::RegisterFieldBool<0,1,0,Int,common::RW> {
...
#[doc = "0 = False"]
    #[inline(always)]
    pub fn boolean(self) -> 
    crate::common::RegisterFieldBool<0,1,0,Register64Bit,common::RW> {
        
    crate::common::RegisterFieldBool::<0,1,0,Register64Bit,common::RW>::from_register(self,0)
    }
}
