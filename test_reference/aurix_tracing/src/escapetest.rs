...
#[doc = "\\[\\]\\\"😀\"\\n\\a\\r\'𒀀𒀽"]
    #[inline(always)]
    pub fn field(self) -> crate::common::RegisterField<1,0x1,1,0,register::Field,register::Field,Register,common::RW> {
        crate::common::RegisterField::<1,0x1,1,0,register::Field,register::Field,Register,common::RW>::from_register(self,0)
    }
}
