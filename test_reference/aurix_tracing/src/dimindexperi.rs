...
impl AReg {
    ...
    #[inline(always)]pub fn arraybitfield_(self,index:u8) -> crate::common::RegisterField<1,0x3,3,2,u8,u8,AReg,common::RW> {
        assert!(index < 3);
        crate::common::RegisterField::<1,0x3,3,2,u8,u8,AReg,common::RW>::from_register(self,index)
     
    }
    #[inline(always)]
    pub fn arraybitfield_c(self) -> crate::common::RegisterField<1,0x3,3,2,u8,u8,AReg,common::RW> {
        crate::common::RegisterField::<1,0x3,3,2,u8,u8,AReg,common::RW>::from_register(self,0)
    }
    
    #[inline(always)]
    pub fn arraybitfield_d(self) -> crate::common::RegisterField<1,0x3,3,2,u8,u8,AReg,common::RW> {
        crate::common::RegisterField::<1,0x3,3,2,u8,u8,AReg,common::RW>::from_register(self,1)
    }
    
    #[inline(always)]
    pub fn arraybitfield_e(self) -> crate::common::RegisterField<1,0x3,3,2,u8,u8,AReg,common::RW> {
        crate::common::RegisterField::<1,0x3,3,2,u8,u8,AReg,common::RW>::from_register(self,2)
    }
...
impl BReg {
    ...
    crate::common::RegisterFieldBool::<0,3,1,BReg,common::RW>::from_register(self,index)
