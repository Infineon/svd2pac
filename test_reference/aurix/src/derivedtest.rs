...
#[doc = "BaseRegister"]
#[inline(always)]
pub const fn baseregister(&self) -> &'static crate::common::Reg<self::BaseRegister_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::BaseRegister_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(4096usize)) }
}


#[inline(always)]
pub const fn derivedregister(&self) -> &'static crate::common::Reg<self::DerivedRegister_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::DerivedRegister_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(4098usize)) }
}


#[inline(always)]
pub const fn derivedfromfaraway(&self) -> &'static crate::common::Reg<self::DerivedFromFarAway_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::DerivedFromFarAway_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(4100usize)) }
}
...
#[doc = "Shows if Timer is running or not"]
    #[inline(always)]
    pub fn run(self) -> crate::common::RegisterField<0,0x1,1,0,baseregister::Run,baseregister::Run,BaseRegister_SPEC,crate::common::R> {
        crate::common::RegisterField::<0,0x1,1,0,baseregister::Run,baseregister::Run,BaseRegister_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
#[inline(always)]
pub const fn reg1(&self) -> &'static crate::common::Reg<baseclustertype::Reg1_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<baseclustertype::Reg1_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(0usize)) }
}
    
#[inline(always)]
pub const fn reg2(&self) -> &'static crate::common::Reg<baseclustertype::Reg2_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<baseclustertype::Reg2_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(4usize)) }
}
    }
