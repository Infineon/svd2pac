...
#[inline(always)]
pub const fn bitfield_reg(&self) -> &'static crate::common::Reg<self::BitfieldReg_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::BitfieldReg_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(0usize)) }
}
...
pub const fn sr(&self) -> &'static crate::common::Reg<self::Sr_SPEC, crate::common::R> {
    unsafe {   crate::common::Reg::<self::Sr_SPEC, crate::common::R>::from_ptr(self._svd2pac_as_ptr().add(4usize)) }
}
...
pub const fn int(&self) -> &'static crate::common::Reg<self::Int_SPEC, crate::common::W> {
    unsafe {   crate::common::Reg::<self::Int_SPEC, crate::common::W>::from_ptr(self._svd2pac_as_ptr().add(16usize)) }
}

 
#[doc = "The Counter Register reflects the actual Value of the Timer/Counter"]
#[inline(always)]
pub const fn nobitfield_reg(&self) -> &'static crate::common::Reg<self::NobitfieldReg_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::NobitfieldReg_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(32usize)) }
}

 
#[doc = "The Match Register stores the compare Value for the MATCH condition"]
#[inline(always)]
pub const fn r#match(&self) -> &'static crate::common::Reg<self::Match_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::Match_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(36usize)) }
}

 
#[doc = "The Prescale Register stores the Value for the prescaler. The cont event gets divided by this value"]
#[inline(always)]
pub const fn prescale_rd(&self) -> &'static crate::common::Reg<self::PrescaleRd_SPEC, crate::common::R> {
    unsafe {   crate::common::Reg::<self::PrescaleRd_SPEC, crate::common::R>::from_ptr(self._svd2pac_as_ptr().add(40usize)) }
}

 
#[doc = "The Prescale Register stores the Value for the prescaler. The cont event gets divided by this value"]
#[inline(always)]
pub const fn prescale_wr(&self) -> &'static crate::common::Reg<self::PrescaleWr_SPEC, crate::common::W> {
    unsafe {   crate::common::Reg::<self::PrescaleWr_SPEC, crate::common::W>::from_ptr(self._svd2pac_as_ptr().add(44usize)) }
}

 
#[doc = "Array of register"]
#[inline(always)]
pub const fn arrayreg(&self) -> &'static crate::common::ClusterRegisterArray<crate::common::Reg<self::Arrayreg_SPEC, crate::common::RW>, 4, 0x4> {
    unsafe { crate::common::ClusterRegisterArray::from_ptr(self._svd2pac_as_ptr().add(0x50usize)) }
}

 
#[doc = "Another defintion register using alternate group"]
#[inline(always)]
pub const fn bitfield_reg_alt_group(&self) -> &'static crate::common::Reg<self::BitfieldRegAltGroup_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::BitfieldRegAltGroup_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(0usize)) }
}

 
#[doc = "64 bit register"]
#[inline(always)]
pub const fn register64bit(&self) -> &'static crate::common::Reg<self::Register64Bit_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::Register64Bit_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(96usize)) }
}
...
pub const fn timer(&self) -> &'static crate::common::Reg<self::Timer_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<self::Timer_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(8192usize)) }
}
...
#[doc = "Raw Bitfield Read Only"]
    #[inline(always)]
    pub fn bitfieldr(self) -> crate::common::RegisterField<3,0x7,1,0,u8,u8,BitfieldReg_SPEC,crate::common::R> {
...
#[doc = "Bitfield Raw Write Only"]
    #[inline(always)]
    pub fn bitfieldw(self) -> crate::common::RegisterField<6,0x3,1,0,u8,u8,BitfieldReg_SPEC,crate::common::W> {
...
#[doc = "BitField Raw Read Write"]
    #[inline(always)]
    pub fn bitfieldrw(self) -> crate::common::RegisterField<8,0xf,1,0,u8,u8,BitfieldReg_SPEC,crate::common::RW> {
...
#[doc = "Bitfield with enumerated field"]
    #[inline(always)]
    pub fn bitfieldenumerated(self) -> crate::common::RegisterField<12,0xf,1,0,bitfield_reg::BitfieldEnumerated,bitfield_reg::BitfieldEnumerated,BitfieldReg_SPEC,crate::common::RW> {
        crate::common::RegisterField::<12,0xf,1,0,bitfield_reg::BitfieldEnumerated,bitfield_reg::BitfieldEnumerated,BitfieldReg_SPEC,crate::common::RW>::from_register(self,0)
    }
     
#[doc = "Array of bitfields"]
    #[inline(always)]pub fn fieldarray(self,index:u8) -> crate::common::RegisterField<16,0x3,8,2,bitfield_reg::FieldArray,bitfield_reg::FieldArray,BitfieldReg_SPEC,crate::common::RW> {
        assert!(index < 8);
        crate::common::RegisterField::<16,0x3,8,2,bitfield_reg::FieldArray,bitfield_reg::FieldArray,BitfieldReg_SPEC,crate::common::RW>::from_register(self,index)
...
#[doc = "Shows if Timer is running or not"]
    #[inline(always)]
    pub fn run(self) -> crate::common::RegisterField<0,0x1,1,0,sr::Run,sr::Run,Sr_SPEC,crate::common::R> {
...
#[doc = "Shows if the MATCH was hit"]
    #[inline(always)]
    pub fn r#match(self) -> crate::common::RegisterField<8,0x1,1,0,sr::Match,sr::Match,Sr_SPEC,crate::common::RW> {
...
#[doc = "Shows if an underflow occured. This flag is sticky"]
    #[inline(always)]
    pub fn un(self) -> crate::common::RegisterField<9,0x1,1,0,sr::Un,sr::Un,Sr_SPEC,crate::common::RW> {
...
#[doc = "Shows if an overflow occured. This flag is sticky"]
    #[inline(always)]
    pub fn ov(self) -> crate::common::RegisterField<10,0x1,1,0,sr::Ov,sr::Ov,Sr_SPEC,crate::common::RW> {
...
#[doc = "Shows if Timer is in RESET state"]
    #[inline(always)]
    pub fn rst(self) -> crate::common::RegisterField<12,0x1,1,0,sr::Rst,sr::Rst,Sr_SPEC,crate::common::R> {
...
#[doc = "Shows the currently active RELOAD Register"]
    #[inline(always)]
    pub fn reload(self) -> crate::common::RegisterField<14,0x3,1,0,sr::Reload,sr::Reload,Sr_SPEC,crate::common::R> {
        crate::common::RegisterField::<14,0x3,1,0,sr::Reload,sr::Reload,Sr_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
#[doc = "Interrupt Enable"]
    #[inline(always)]
    pub fn en(self) -> crate::common::RegisterField<0,0x1,1,0,int::En,int::En,Int_SPEC,crate::common::RW> {
...
#[doc = "Interrupt Mode, selects on which condition the Timer should generate an Interrupt"]
    #[inline(always)]
    pub fn mode(self) -> crate::common::RegisterField<4,0x7,1,0,int::Mode,int::Mode,Int_SPEC,crate::common::RW> {
        crate::common::RegisterField::<4,0x7,1,0,int::Mode,int::Mode,Int_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Register64Bit {
    ...
    #[inline(always)]
    pub fn boolean(self) -> crate::common::RegisterField<0,0x1,1,0,register64bit::Boolean,register64bit::Boolean,Register64Bit_SPEC,crate::common::RW> {
        crate::common::RegisterField::<0,0x1,1,0,register64bit::Boolean,register64bit::Boolean,Register64Bit_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
pub const fn cr(&self) -> &'static crate::common::Reg<cluster1::Cr_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<cluster1::Cr_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(0usize)) }
}
...
impl Cr {
    ...
    #[inline(always)]
    pub fn filed1(self) -> crate::common::RegisterField<0,0x7,1,0,u8,u8,Cr_SPEC,crate::common::RW> {
        crate::common::RegisterField::<0,0x7,1,0,u8,u8,Cr_SPEC,crate::common::RW>::from_register(self,0)
    }
    
    #[inline(always)]
    pub fn psc(self) -> crate::common::RegisterField<3,0x3,1,0,cr::Psc,cr::Psc,Cr_SPEC,crate::common::RW> {
...
#[inline(always)]
pub const fn nestedreg(&self) -> &'static crate::common::Reg<cluster1::NestedReg_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<cluster1::NestedReg_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(0usize)) }
}
    }
...
#[inline(always)]
pub const fn hsslxcoky(&self) -> &'static crate::common::Reg<hssl_hssl_ch::HssLxCoKy_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<hssl_hssl_ch::HssLxCoKy_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(0usize)) }
}
    }
...
pub const fn cr(&self) -> &'static crate::common::Reg<clusterdim::Cr_SPEC, crate::common::RW> {
    unsafe {   crate::common::Reg::<clusterdim::Cr_SPEC, crate::common::RW>::from_ptr(self._svd2pac_as_ptr().add(0usize)) }
}
    }
...
impl Cr {
    ...
    #[inline(always)]
    pub fn field1(self) -> crate::common::RegisterField<0,0x7,1,0,u8,u8,Cr_SPEC,crate::common::RW> {
        crate::common::RegisterField::<0,0x7,1,0,u8,u8,Cr_SPEC,crate::common::RW>::from_register(self,0)
    }
