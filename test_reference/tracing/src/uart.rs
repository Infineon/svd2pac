...
impl super::Uart {
    ...
    pub const fn reg1_(
        ...
        crate::common::Reg<self::Reg1_SPEC, crate::common::RW>,
        2,
        0x4,
    > {
        unsafe {
    ...
    #[inline(always)]
    pub const fn regbitfieldraw(
        &self,
    ) -> &'static crate::common::Reg<self::RegBitfieldRaw_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::RegBitfieldRaw_SPEC, crate::common::RW>::from_ptr(
    ...
    #[inline(always)]
    pub const fn reg16bitenum(
        &self,
    ) -> &'static crate::common::Reg<self::Reg16BitEnum_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Reg16BitEnum_SPEC, crate::common::RW>::from_ptr(
    ...
    #[inline(always)]
    pub const fn reg8bitraw(
        &self,
    ) -> &'static crate::common::Reg<self::Reg8BitRaw_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Reg8BitRaw_SPEC, crate::common::RW>::from_ptr(
    ...
    #[inline(always)]
    pub const fn reg16bitraw(
        &self,
    ) -> &'static crate::common::Reg<self::Reg16BitRaw_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Reg16BitRaw_SPEC, crate::common::RW>::from_ptr(
    ...
    #[doc = "Read write without enum"]
    #[inline(always)]
    pub const fn reg32bitraw(
        &self,
    ) -> &'static crate::common::Reg<self::Reg32BitRaw_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Reg32BitRaw_SPEC, crate::common::RW>::from_ptr(
    ...
    #[inline(always)]
    pub const fn regenumvalue(
        &self,
    ) -> &'static crate::common::Reg<self::RegEnumValue_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::RegEnumValue_SPEC, crate::common::RW>::from_ptr(
...
pub mod regenumvalue {
    ...
    pub type ReadWriteEnumSplitBinaryRead =
        crate::EnumBitfieldStruct<u8, ReadWriteEnumSplitBinaryRead_SPEC>;
    ...
    pub type ReadWriteEnumSplitBinaryWrite =
        crate::EnumBitfieldStruct<u8, ReadWriteEnumSplitBinaryWrite_SPEC>;
...
impl _Uart {
    ...
    pub const fn uart(&self) -> &'static crate::common::Reg<uart::Uart_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<uart::Uart_SPEC, crate::common::RW>::from_ptr(
...
pub mod uart {
    ...
    impl Uart {
        ...
        pub fn uart(
            self,
        ) -> crate::common::RegisterField<0, 0x7, 1, 0, u8, u8, Uart_SPEC, crate::common::RW>
        {
